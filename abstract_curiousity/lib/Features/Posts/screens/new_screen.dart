...
import 'package:abstract_curiousity/Features/Posts/screens/display.dart';
...
class _NewScreenState extends State<NewScreen> {
  ...
  String getFormattedText() {
    final delta = controller.getDelta();
        ...
        bottomNavigationBar: Container(
          ...
          child: Column(
            children: [
              ElevatedButton(
                onPressed: () async {
                  String formattedText = await controller.getText();
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => DisplayScreen(title: formattedText),
                    ),
                  );
                },
